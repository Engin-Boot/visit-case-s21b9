...
namespace SenderTestFunc
{
    public class UnitTest1
    {
        ...
        public void WhenFileDoesNotExistThenReturnFalseAndSendErrorMessage()
        {
            ...
            string correctFilePath = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\Visit-record-inputs.csv";
            //Passing condition
            ...
            string wrongFilePath = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\Visit-record-input.csv";
        ...
        public void WhenFileDoesNotHasValidExtensionThenReturnFalseAndSendErrorMessage()
        {
            ...
            string correctFileExtension = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\Visit-record-inputs.csv";
            //Passing condition
            ...
            string wrongFileExtension = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\Visit-record-inputs.xlsx";
        ...
        public void WhenFileIsEmptyThenReturnTrueAndSendErrorMessage()
        {
            ...
            string nonEmptyFile = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\Visit-record-inputs.csv";
            //Failing condition
            ...
            string emptyFile = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\EmptyFile.csv";
        ...
        {
            Sender.Program sg = new Sender.Program();
            string fileNotInUse = @"C:\Users\320087363\visit-case-s21b9\Sender\TestDataFiles\Visit-record-inputs.csv";
            //Failing condition
